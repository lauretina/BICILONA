...
<head>
    ...
    <meta name="description" content="Consulta las condiciones legales de Bicilona, política de cookies, de privacidad y aviso legal, todo bajo normativa de la UE.">
    <title>Condiciones legales para la aplicación web BiciLona, foro y tienda para una comunidad de ciclistas</title>
...
<body>
    <?php
        include_once '../Controlador/headersession.php';
    ?>
    <!-- Contenido principal -->
    <main>
        ...
        <p>La presente Política de Privacidad establece los términos en que BiciLona usa y protege la información 
            ...
            <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
                ...
                cualquier momento. BiciLona está altamente comprometido para cumplir con el compromiso de mantener su información segura. 
            ...
            <p>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse en su ordenador, 
                ...
                las futuras visitas a una web recurrente. Otra función que tienen las cookies es que con ellas las web pueden reconocerte 
                individualmente y por tanto brindarte el mejor servicio personalizado de su web.
                Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta información 
                es empleada únicamente para análisis estadístico y después la información se elimina de forma permanente. Usted puede eliminar 
                las cookies en cualquier momento desde su ordenador. Sin embargo las cookies ayudan a proporcionar un mejor servicio de los sitios 
                web, estás no dan acceso a información de su ordenador ni de usted, a menos de que usted así lo quiera y la proporcione directamente 
                noticias. Usted puede aceptar o negar el uso de cookies, sin embargo la mayoría de navegadores aceptan cookies automáticamente pues 
                sirve para tener un mejor servicio web. También usted puede cambiar la configuración de su ordenador para declinar las cookies. Si 
            ...
            <p>En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada a nuestro 
                sitio web.  Cada vez que se le solicite rellenar un formulario, como el de alta de usuario, puede marcar o desmarcar la opción 
                de recibir información por correo electrónico.  En caso de que haya marcado la opción de recibir nuestro boletín o publicidad 
                usted puede cancelarla en cualquier momento. Esta compañía no venderá, cederá ni distribuirá la información personal que es 
                recopilada sin su consentimiento, salvo que sea requerido por un juez con un orden judicial.
                    
                BiciLona Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.</p>
        </section>
    </main>
    <!-- Pie de página -->
    <footer>
        <div><a href="avisolegal.php">Aviso legal</a></div>
        <div><a href="#">Política de privacidad</a></div>
        <div><a href="cookies.php">Política de cookies</a></div> 
        <div>&#169; 2023 BiciLona</div>
     </footer>
    <!-- Javascript -->
